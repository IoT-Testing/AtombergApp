...
/**
 * AppUtil â€“ common helper methods used across all test classes.
 */
public class AppUtil {
    ...
    // Wi-Fi provisioning credentials â€” read from the environment, never committed.
    ...
    // â”€â”€ Screenshots â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
     ...
     * Written from page-object taps on both driver threads â†’ volatile.
     */
    ...
    /** The last recorded action label â€” used as the fallback screenshot name. */
    ...
    public static void captureScreenshot(AndroidDriver driver, String name) {
        ...
        // so raw names reach here containing newlines â€” and a newline in a path is
        ...
        try {
            ...
            logpoint("Screenshot saved: " + destPath);
    ...
    // â”€â”€ Home device tiles â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
     ...
     * {@code SharingLocators.deviceCardOnHome} ORs â€” a run on 2026-08-07 scanning
    ...
    // â”€â”€ Element helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
     ...
     * screen transition â€” previously this threw an uncaught exception, causing false failures.
     */
     ...
     * Boolean.parseBoolean(null) == false, so every click was silently skipped â€”
     ...
     * <p>
     * FIX H5: old fallback used Tap.withCoordinates(driver, 540, 1850) â€” a pixel
    ...
    public static void navigateToAddScreen(AndroidDriver driver) {
        try {
            ...
            logpoint("Add button not found via locator â€” using percentage-based fallback.");
     ...
     * and, after every press, checks whether the app is still in the foreground â€”
    ...
    public static void ensureAppHome(AndroidDriver driver, int maxBacks) {
        if (!isAppInForeground(driver)) {
            logpoint("[AppUtil] App not in foreground â€” re-activating.");
        ...
        for (int i = 0; i < maxBacks; i++) {
            ...
            if (!isAppInForeground(driver)) {
                // That back press left the app â€” undo it and stop pressing.
                logpoint("[AppUtil] BACK exited the app â€” re-activating and stopping.");
                try { driver.activateApp(ATOMBERG_HOME); } catch (Exception ignored) {}
                sleep(2000);
                return;
            }
    ...
    // â”€â”€ Wi-Fi provisioning â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
