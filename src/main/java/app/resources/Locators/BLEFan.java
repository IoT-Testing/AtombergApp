...
public class BLEFan {
    ...
    public static final int PAUSE_RESUME_CYCLES = 20;
    public static final long HOLD_DURATION_MS = 1350; // Matches your proven timing
    public static final long FIRMWARE_SUCCESS_TIMEOUT_MS = 20_000;
    public static final By FILE_LIST_ITEM = By.className("android.widget.TextView");
