...
public class FanLocators {
    ...
    public static final By TIMER_SCREEN = By.xpath("//android.view.View[@content-desc=\"Timer\n" +
            "Hours\"]");
    public static final By TIMER_ON = By.xpath("//android.widget.ImageView[@bounds=\"[191,1839][380,2223]\"]");
    public static final By TIMER_ONE = By.xpath("//android.view.View[@content-desc=\"1\"]");
    public static final By TIMER_TWO = By.xpath("//android.view.View[@content-desc=\"2\"]");
    public static final By TIMER_THREE = By.xpath("//android.view.View[@content-desc=\"3\"]");
    public static final By TIMER_SIX = By.xpath("//android.view.View[@content-desc=\"6\"]");
                                                                                                                //[442,2096][638,2293]
