...
public class Swipe {
	// Screen swipes
	public static void Left(IOSDriver driver, double x, double y) {
	...
	public static void Right(IOSDriver driver, double x, double y) {
		Dimension size = driver.manage().window().getSize(); // Assuming getWindowSize() returns the window size
		int startY = (int) (size.getHeight() * y);
	...
	public static void screenRight(IOSDriver driver) {
		Dimension size = driver.manage().window().getSize(); // Assuming getWindowSize() returns the window size
	...
	public static void screenLeft(IOSDriver driver) {
		Dimension size = driver.manage().window().getSize(); // Assuming getWindowSize() returns the window size
